...
function FAQ() {
  const faqData = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "¿Dónde está ubicado Huicha Aventuras en Tandil?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Huicha Aventuras está ubicado en Av. Estrada 2641, Tandil, Buenos Aires. Somos el complejo de actividades de aventura más completo de Tandil, ofreciendo paintball, trekking, arquería y más actividades al aire libre."
        }
      },
      {
        "@type": "Question",
        "name": "¿Qué actividades de aventura ofrecen en Tandil?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Ofrecemos paintball táctico, trekking por las sierras de Tandil, arquería tradicional, guerra con arco, juegos de orientación, footgolf y cocina rústica al aire libre. Todas nuestras actividades están supervisadas por instructores certificados."
        }
      },
      {
        "@type": "Question",
        "name": "¿Hacen cumpleaños de aventura en Tandil?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sí, somos especialistas en cumpleaños de aventura en Tandil para niños hasta 13 años. Ofrecemos fiestas de cumpleaños temáticas con actividades seguras y supervisadas, perfectas para crear recuerdos inolvidables en Tandil."
        }
      },
      {
        "@type": "Question",
        "name": "¿Tienen paquetes para egresados en Tandil?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sí, ofrecemos los mejores paquetes para egresados en Tandil y excursiones escolares en Tandil. Nuestras actividades están diseñadas para grupos de estudiantes, combinando diversión, aprendizaje y trabajo en equipo. Perfecto para colegios y escuelas de Tandil."
        }
      },
      {
        "@type": "Question",
        "name": "¿Qué incluyen las actividades familiares en Tandil?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nuestras actividades familiares en Tandil incluyen trekking familiar, arquería para todas las edades, juegos de orientación educativos y cocina rústica al aire libre. Diseñadas para fomentar el trabajo en equipo familiar y la conexión con la naturaleza de Tandil."
        }
      },
      {
        "@type": "Question",
        "name": "¿Cómo puedo contactar Huicha Aventuras?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Puedes contactarnos al teléfono +54 2494 38 1198 o por email a info@huichaaventuras.com. También nos encuentras en Instagram @huicha.aventuras. Estamos ubicados en Av. Estrada 2641, Tandil."
        }
      }
    ]
  };
